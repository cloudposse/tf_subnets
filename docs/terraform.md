...
| <a name="input_create_private_subnets"></a> [create\_private\_subnets](#input\_create\_private\_subnets) | Set to false to prevent the module from creating private subnets. Some of your CIDR block will still be reserved, so you can change this later without disruption. | `bool` | `true` | no |
| <a name="input_create_public_subnets"></a> [create\_public\_subnets](#input\_create\_public\_subnets) | Set to false to prevent the module from creating public subnets. Some of your CIDR block will still be reserved, so you can change this later without disruption. | `bool` | `true` | no |
